...
const tenantIndexes = [
  ...
  [
    'team_task_review_delegations',
    'ix_team_task_review_delegations_tenant_window',
    [
      'organization_id',
      'project_id',
      'delegator_user_id',
...
const lineageIndexes = [
  ...
  index('team_task_review_delegations', 'uk_team_task_review_delegations_id_lineage', true, [
    'id',
    'organization_id',
    'project_id',
    'delegate_user_id',
...
export const TEAM_WORK_ITEM_SCHEMA_CONTRACT = {
  ...
  foreignKeys: [
    ...
    foreignKey(
      'team_work_item_reviews',
      'fk_team_work_item_reviews_delegation_lineage',
      ['review_delegation_id', 'organization_id', 'project_id', 'reviewer_user_id'],
      'team_task_review_delegations',
      ['id', 'organization_id', 'project_id', 'delegate_user_id'],
    ),
    foreignKey(
      'team_task_review_delegations',
      'fk_team_task_review_delegations_organization',
      ['organization_id'],
      'organizations',
      ['id'],
    ),
    foreignKey(
      'team_task_review_delegations',
      'fk_team_task_review_delegations_project_tenant',
    ...
    foreignKey(
      'team_task_review_delegations',
      'fk_team_task_review_delegations_delegator',
      ['delegator_user_id'],
      'users',
      ['id'],
    ),
    foreignKey(
      'team_task_review_delegations',
      'fk_team_task_review_delegations_delegate',
      ['delegate_user_id'],
      'users',
      ['id'],
    ),
    foreignKey(
      'team_task_review_delegations',
      'fk_team_task_review_delegations_revoked_by',
      ['revoked_by_user_id'],
      'users',
      ['id'],
    ),
  ...
  columns: [
    ...
    column('team_task_review_delegations', 'revoked_by_user_id', 'bigint', 'bigint unsigned', true),
