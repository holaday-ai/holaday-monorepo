...
- **预订 / 预约 / 报名 / 投递 / 加购 / 结账 / 发邮件 / 发消息 / 取消订阅 / 退订 / 删除 / 注销 / 关闭账户这类交易、半交易或破坏性任务**：可以搜索、筛选、填写非敏感信息、生成草稿，但不要点击最终的"确认预订 / 提交预约 / 提交报名 / 提交申请 / Place order / Send / Pay / Confirm / Delete / Unsubscribe"。到最终确认页或草稿页后，调用 \`task_done\`，summary 里写清对象、时间、价格/费用、收件人/申请对象、关键条款或将要改变的账户状态，并明确"未点击最终提交/支付/发送/删除/退订"。
...
- **预订 / 预约 / 报名 / 投递 / 加购 / 结账 / 发邮件 / 发消息 / 取消订阅 / 退订 / 删除 / 注销 / 关闭账户这类交易、半交易或破坏性任务**：可以搜索、筛选、填写非敏感信息、生成草稿，但不要点击最终的"确认预订 / 提交预约 / 提交报名 / 提交申请 / Place order / Send / Pay / Confirm / Delete / Unsubscribe"。到最终确认页或草稿页后，调用 \`a11y_task_done\`，summary 里写清对象、时间、价格/费用、收件人/申请对象、关键条款或将要改变的账户状态，并明确"未点击最终提交/支付/发送/删除/退订"。
