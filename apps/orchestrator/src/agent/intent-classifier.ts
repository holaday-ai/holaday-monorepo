...
const INTERACTION_PATTERNS: readonly [RegExp, string][] = [
  ...
  [/\b(?:create|edit|update|save|add|upload|generate|make|publish|schedule|fill\s+out)\s+.{1,80}\s+(?:in|on|to)\s+(?:https?:\/\/|www\.|[a-z0-9.-]+\.[a-z]{2,24})\b/i, 'action-first domain app workflow'],
