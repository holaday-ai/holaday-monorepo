...
export const POSTMARKET_SAMPLE: PostmarketBriefingInput = {
  ...
  indexCn: {
    data: [
      { 名称: '上证指数', 代码: '000001', 最新价: 3125.4, 涨跌幅: 0.42, 成交额: 435_000_000_000 },
      { 名称: '深证成指', 代码: '399001', 最新价: 9842.7, 涨跌幅: 0.18, 成交额: 380_000_000_000 },
      { 名称: '创业板指', 代码: '399006', 最新价: 1987.3, 涨跌幅: -0.25, 成交额: 160_000_000_000 },
    ],
    count: 3,
    source: 'akshare:stock_zh_index_spot_em(沪深重要指数)',
    fetched_at: '2026-06-11T07:25:00Z',
    disclaimer: DISCLAIMER,
  },
  northbound: {
    data: [
      { 板块: '沪股通', 成交净买额: 25.3, 买入成交额: 312.4, 卖出成交额: 287.1 },
      { 板块: '深股通', 成交净买额: 16.88, 买入成交额: 280.6, 卖出成交额: 263.72 },
    ],
    count: 2,
