...
/** 荐股/买卖建议措辞（含诱导问常见词：该买/割肉/止损止盈/要不要买卖）。 */
export const ADVICE_PATTERN =
  /建议(买入|卖出|买|卖|加仓|减仓|持有|配置|关注)|目标价|必涨|必跌|强烈推荐|涨停可期|抄底|梭哈|满仓|清仓|值得(买入|入手|拥有|配置)|可以(买入|入手|建仓|加仓|考虑)|该(买|卖|不该买)|要不要(买|卖|割|加|减)|割肉|止损|止盈|加仓|减仓|逢低|逢高|上车|建仓|减持(?!.*公告)|高抛低吸/;
