...
## 🔴 PROD LIVE REF = `claude/musing-keller-ae1d05` — orch `36d7705f`（**B4 截图锚 dark ship · B4_SCREENSHOT_ANCHOR OFF / ACTION_CAPTURE ON**）/ SPA `8da47b4b`（bundle `index-DiYh_GAx.js`，未变）
