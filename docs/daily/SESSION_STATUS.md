...
## 🔴 PROD LIVE REF = `claude/musing-keller-ae1d05` — orch `437ab87c`（**B3 穿 frame 捕获 · ACTION_CAPTURE ON canary**）/ SPA `8da47b4b`（bundle `index-DiYh_GAx.js`，未变）

<!-- 2026-06-22 — Playbook B3：iframe 命中→路由进 frame 捕文本锚（一层/string形/独立 withTimeout 退坐标）-->
