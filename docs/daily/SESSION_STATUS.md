...
## 🔴 PROD LIVE REF = `claude/musing-keller-ae1d05` — orch `1bf7ceb7`（**B3 验证夹具 · B3_FIXTURE_ENABLED ON(临时) + ACTION_CAPTURE ON**）/ SPA `8da47b4b`（bundle `index-DiYh_GAx.js`，未变）

<!-- 2026-06-22 — Playbook B3 受控验证夹具：flag-gated 跨域 iframe 测试页（验完翻 flag OFF）-->
